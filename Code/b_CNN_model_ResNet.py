...
# This part creates the classes and scores from the validation data for the plots
y_score = []
true_classes = []
predicted_classes = []
...
# Let's also check the Precision-Recall Curve, and the Threshold Plots 
...
plt.savefig("precision-recall-threshold.png", bbox_inches='tight')
