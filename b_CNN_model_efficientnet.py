...
data_transforms = transforms.Compose([
        transforms.Resize([384,384]), # Minimum size needed for Efficientnet
        transforms.ToTensor(),
        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225]) # Required normalisation for Efficientnet
    ])
